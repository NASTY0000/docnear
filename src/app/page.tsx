    ...
    <AppShell user={user}>
      <section className="grid gap-8 py-6 md:grid-cols-2 md:items-center">
        <div>
          ...
          <p className="mt-3 text-xs text-ink-700/70 dark:text-tide-400">Currency NGN. Demo payments only — no live keys.</p>
        </div>
        <div className="card space-y-4 p-5">
          ...
          <ol className="space-y-3 text-sm">
            ...
            <li><strong>3. Pay for advice.</strong> Demo checkout. Chat opens. When you complete, the doctor is credited minus 15%.</li>
          </ol>
          <Disclaimer compact />
        </div>
      </section>
      <section className="mt-4 grid gap-4 sm:grid-cols-3">
        {[
          ...
          { t: "Doctors", d: "Go online, take advice sessions, and cash out a demo wallet with a real ledger." },
